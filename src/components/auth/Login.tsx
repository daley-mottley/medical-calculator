...
const Login: React.FC = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    if (values.email && values.password) {
      ...
      // Handle case where email or password is not provided (e.g., guest login attempt via submit)
      console.log("Email or password not provided for login attempt.");
      // Optionally show an error or prompt the user
    }
  };
