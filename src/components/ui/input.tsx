      ...
      <div className="relative flex w-full items-center">
        ...
        {hasValue && isTextLike && (
          <button
            ...
            onClick={handleClear}
            className="absolute right-0 mr-3 rounded-full p-1 text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            <X className="h-4 w-4" />
          </button>
        )}
